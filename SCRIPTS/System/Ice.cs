...
public class Ice : Damageable
{
    ...
    protected override void Die() // This method is called when the ice is destroyed
    {
        base.Die(); // Call the base class Die method
        starManager.scorePoints += 1250; // Add points to the score when the wood is destroyed
    }
}
